...
BestInPlaceEditor.prototype = {
            ...
            default:
                if (value !== "") {
                    if (this.display_raw) {
                        ...
                        editor.element.text(value).removeClass("placeholdered");
                    }
                } else {
                    editor.element.html(this.placeHolder).addClass("placeholdered");
                }
        }
    ...
    initPlaceHolder: function () {
        ...
        if (this.element.html() === "") {
            this.element.html(this.placeHolder).addClass("placeholdered");
        }
    },
